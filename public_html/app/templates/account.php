	    ...
	    <div class="col-xs-12" id="kitchen-posts">
	    		...
	    		<h2 class="upload-header">Upload Your Own DIY Cleaning Recipes</h2>
					...
					<div class="form-group">
						...
						<textarea  class="form-control ckeditor" name="recipe-desc" cols"5" rows="10"><?= isset($_POST['recipe-desc']) ? $_POST['recipe-desc'] : '' ?></textarea>
						<?= isset($descMessage) ? $descMessage : '' ?>
					</div>

					<div class="form-group">
						<label for"method">Method</label>
						<textarea  class="form-control ckeditor" name="recipe-methods" cols"80" rows="10"><?= isset($_POST['method']) ? $_POST['method'] : '' ?></textarea>
